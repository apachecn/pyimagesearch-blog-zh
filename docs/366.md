...
| ***x***<sub>0</sub> | ***x***<sub>1</sub> | ***x*<sub>0</sub>&x<sub>1</sub>** | ***x***<sub>0</sub> | ***x***<sub>1</sub> | ***x***<sub>**0**</sub>***x***<sub>**1**</sub> | ***x***<sub>0</sub> | ***x***<sub>1</sub> | ***x***<sub>**0**</sub>**∧*****x***<sub>**1**</sub> |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
正如我们在左边的*上看到的，当且仅当*两个输入值都是`1`时，逻辑与为真*。如果输入值的*或*为`0`，则 AND 返回`0`。因此，当 and 的输出为真时，只有一个组合，*x*0= 1 和 *x* <sub>1</sub> = 1。*
...
实际的“学习”发生在步骤 2b 和 2c 中。首先，我们通过网络传递特征向量*x<sub>j</sub>，取与权重*w的点积，得到输出*y<sub>j</sub>。然后，该值通过 step 函数传递，如果*x>0，该函数将返回 1，否则返回 0。****
