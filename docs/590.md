...
> 原文:[https://pyimagesearch . com/2021/01/19/image-masking-with-opencv/](https://pyimagesearch.com/2021/01/19/image-masking-with-opencv/)
...
**要了解如何使用 OpenCV 执行图像遮罩，*请继续阅读。*T3】**
